...
<body class="font-sans antialiased bg-gray-100 text-gray-600 dark:text-gray-400 dark:bg-gray-900">
    <div class="">
        <div class="relative min-h-screen flex flex-col selection:bg-[#2c3a58] selection:text-white">
            <div class="relative w-full">
                <header class="bg-home-hero">
                    @if (Route::has('login'))
                    <nav class="max-w-screen-2xl mx-auto flex flex-1 justify-between items-center py-3">
                        <div>
                            <a
                                href="{{ route('home') }}"
                        ...
                        <div>
                            ...
                            <span class="text-gray-700 dark:text-white">Welcome, {{ Auth::user()->name }}!</span>
                            ...
                            <a
                                href="{{ route('login') }}"
                                class="inline-flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-medium text-white dark:text-gray-800 hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150 ms-3"> 
                                Login
